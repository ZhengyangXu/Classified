...
Base Case
==============
when it's a pure string (no '[') return s

recurse
===============
Find times on lfet string then
elf.expressionExpand(leftstring) * times + self.expressionExpand(rightstring)
care for two situations
